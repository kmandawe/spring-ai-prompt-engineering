...
public class GiveClearInstructionsTests extends BaseTestClass {
  ...
  void testCookSteak() {
    PromptTemplate promptTemplate =
        new PromptTemplate(directionsPrompt, Map.of("text_1", cookASteak));
  ...
  void testBookDescription() {
    PromptTemplate promptTemplate =
        new PromptTemplate(directionsPrompt, Map.of("text_1", bookDescription));
  ...
  void testCookSteakAsSnoopDog() {
    PromptTemplate promptTemplate =
        new PromptTemplate(
            directionsPrompt + "Give the directions using the tone of Snoop Dog",
